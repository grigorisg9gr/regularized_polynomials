...
from speech_commands_dataset import speech_command_db as return_loaders
try:
...
def main(yml_name=None, seed=None, label='', use_cuda=True):
    ...
    if yml_name is None:
        ...
        parser.add_argument('--config_path', type=str, default='.yml')
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=mil,
