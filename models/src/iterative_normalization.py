...
class IterNorm(torch.nn.Module):
    def __init__(self, num_features, num_groups=1, num_channels=64, T=5, dim=4, eps=1e-5, momentum=0.1, affine=True,
                 *args, **kwargs):
        ...
        print('channels in iterative norm: {}'.format(self.num_channels))
