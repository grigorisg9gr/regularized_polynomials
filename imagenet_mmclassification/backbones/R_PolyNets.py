...
from mmcls.models.backbones.src.iterative_normalization import IterNorm
from mmcls.models.backbones.src.normalisation_scheme import SwitchNorm2d, DBN, IBN, BatchInstanceNorm2d 
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, use_alpha=False, n_lconvs=1,
                 norm_local=0, kern_loc=1, norm_layer=2, norm_x=-1, **kwargs):
        """
...
class R_PolyNets(nn.Module):
    def __init__(self, block=BasicBlock, num_blocks=[2,2,2,2], num_classes=1000, norm_layer=['a', 'a', 'a', 0],
                 pool_adapt=True, n_channels=[64, 128, 256, 512], ch_in=3, **kwargs):
